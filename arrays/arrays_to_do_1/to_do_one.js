// Arrays To Do 1
// Use the JavaScript language for all challenges. Do not use built-in methods (unless otherwise instructed) or create any additional arrays. (.length is a property, and is allowed.)

// Push Front
// Given an array and an additional value, insert this value at the beginning of the array. You may use .push(),
// but you can do this without it!
// Examples:
